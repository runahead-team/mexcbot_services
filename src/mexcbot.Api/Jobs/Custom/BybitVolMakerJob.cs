...
{
    public class BybitVolMarkerJob : BackgroundService
    {
        private readonly IBotService _botService;

        public BybitVolMarkerJob(IBotService botService)
        {
        ...
        private async Task Run(BotDto bot)
        {
            ...
            try
            {
                ...
                {
                    BotExchangeType.BYBIT => new BybitClient(Configurations.BybitUrl, bot.ApiKey, bot.ApiSecret),
                ...
                if (bot.VolumeOption != null)
                {
                    ...
                    var btcUsdVolumePredict =
                        decimal.Parse(btcCandleStickPredict[6].Value<string>(), new NumberFormatInfo());
                    ...
                    var botUsdVolumeReal =
                        decimal.Parse(botCandleStickAtNow[6].Value<string>(), new NumberFormatInfo());
